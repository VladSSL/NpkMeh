  ...
  app.innerHTML = `
    ...
    <header class="site-header document-header">
      <a class="brand-lockup" href="./index.html" aria-label="На главную">
        <svg class="brand-triangle" width="34" height="30" viewBox="0 0 169 147" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path d="M90.2094 143.05C87.4655 147.772 80.6555 147.792 77.8838 143.086L48.4139 93.0516L73.3268 78.6926L80.9643 91.442C82.3624 93.7758 85.7511 93.7513 87.1155 91.3977L120.337 34.0832C121.718 31.7018 120 28.7191 117.248 28.7191L50.6562 28.7199C47.915 28.7199 46.1963 31.6826 47.556 34.064L54.8431 46.8256L29.9334 61.1828L0.95897 10.7019C-1.77473 5.93913 1.66184 0 7.15148 0H160.927C166.434 0 169.868 5.97232 167.1 10.7351L90.2094 143.05Z" fill="currentColor"/>
          <path d="M37.3262 73.93L33.6281 67.5573L58.5411 53.1983L62.236 59.5728L37.3262 73.93Z" fill="currentColor"/>
          <path d="M44.719 86.6771L41.0211 80.3045L65.9339 65.9454L69.6288 72.3199L44.719 86.6771Z" fill="currentColor"/>
        </svg>
        <span>
          <strong>МРНК.РФ</strong>
